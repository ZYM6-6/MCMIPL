...
class MovieGraph(object):
    ...
    def __get_user__(self):
        with open('./data/movie/UI_Interaction_data/review_dict_test.json', 'r', encoding='utf-8') as f:
    ...
    def __get_item__(self):
        with open('./data/movie/fea_item/item_feature.pkl','rb') as f:
            item_feature=pickle.load(f)
        with open('./data/movie/fea_item/small_to_large.pkl','rb') as f:
